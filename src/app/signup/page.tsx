    ...
    <div className="min-h-screen bg-surface-950 auth-pattern flex items-center justify-center px-6">
      <div className="w-full max-w-[420px]">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-bold text-white mt-6 mb-2">Crea Account</h1>
          <p className="text-surface-400 text-sm">Inizia a monitorare la tua visibilità AI</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="text-surface-400 text-xs font-medium mb-1.5 block">Conferma Password</label>
            <div className="relative">
              <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-surface-500" />
              <input
                type="password"
        ...
        <p className="text-center text-surface-500 text-sm mt-8">
          Hai già un account?{' '}
          <Link href="/signin" className="text-brand-400 hover:text-brand-300 font-medium transition-colors">
            Accedi
          </Link>
        </p>
      </div>
